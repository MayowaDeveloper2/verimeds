...
export default function Body() {
    ...
    return (
      <div>
        <Navbar />
        <div className="w-full bg-[#d5f7ff] py-[30px] lg:py-[50px] flex flex-col items-center lg:px-[100px] px-[20px]">
            
            
            <div className="mt-[40px] text-center">
                <div className="text-[#325982] text-[20px]">
                  Align the barcode within the scanning frame to verify the drug’s authenticity.
                </div>
            </div>
            ...
            <div className="mt-6 flex gap-4 justify-center flex-wrap">
                ...
                <button
                    ...
                    className="relative hidden cursor-pointer border-2 border-blue-500 text-blue-500 hover:bg-blue-50 font-bold py-3 px-8 rounded-full items-center"
                >
           ...
           {manualInputVisible && (
                <div className="mt-6  hidden w-full max-w-lg flex-col gap-2 items-center">
                    <input
                        type="text"
